  ...
  return (
    <>
      {item.name == "GetActus" ? (
        ...
        >
          <Animatable.View ref={viewRef} duration={250} style={styles.btn}>
            <Animatable.View
              ref={circleRef}
              duration={250}
              style={{
        ...
        >
          <Animatable.View ref={viewRef} duration={250} style={styles.btn}>
            ...
            <Media
              fill={"none"}
              stroke2={"none"}
              stroke={focused ? "#fff" : "#04be9380"}
              fill2={focused ? "#fff" : "#04be9380"}
            />
          </Animatable.View>
        </TouchableOpacity>
      ) : item.name == "Horaires" ? (
